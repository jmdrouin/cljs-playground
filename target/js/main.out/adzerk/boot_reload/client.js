...
var hostname = (function (){var G__10957 = window;
var G__10957__$1 = (((G__10957 == null))?null:G__10957.location);
if((G__10957__$1 == null)){
return null;
} else {
return G__10957__$1.hostname;
}
})();
...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__10958,opts){
...
var files = cljs.core.get.call(null,map__10959__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var args10961 = [];
var len__8226__auto___10964 = arguments.length;
var i__8227__auto___10965 = (0);
while(true){
if((i__8227__auto___10965 < len__8226__auto___10964)){
args10961.push((arguments[i__8227__auto___10965]));

var G__10966 = (i__8227__auto___10965 + (1));
i__8227__auto___10965 = G__10966;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args10961.length)].join('')));
